...
def for_3_points():
    ...
    results_x, _ = compare_AIs(agent1, agent2, n_games)

    agent1 = AlphaBetaAgent("o", heuristic="advanced")
    agent2 = AlphaBetaAgent("x", heuristic="simple")
    results_o, _ = compare_AIs(agent1, agent2, n_games)

    print_info(3, results_x["x"] >= 0.8 * n_games and results_o["o"] >= 0.8 * n_games)
